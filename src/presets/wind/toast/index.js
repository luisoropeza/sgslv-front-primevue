export default {
    ...
    container: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                'text-blue-500 dark:text-blue-300 bg-blue-50': props.message.severity == 'info',
                'text-green-500 dark:text-green-300 bg-green-50': props.message.severity == 'success',
                'text-orange-500 dark:text-orange-300 bg-orange-50': props.message.severity == 'warn',
                'text-red-500 dark:text-red-300 bg-red-50': props.message.severity == 'error'
            }
        ]
    }),
    content: ({ props }) => ({
